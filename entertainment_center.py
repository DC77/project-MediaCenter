...
rush = media.Movie(
    "Rush",
    "History of two of the best F1 drivers.",
...
pacific_rim = media.Movie(
    "Pacific Rim",
    "Aliens (from the ocean!) vs. Mechs.",
...
guardians = media.Movie(
    ...
    "Group of misfit aliens saves the galaxy.",
